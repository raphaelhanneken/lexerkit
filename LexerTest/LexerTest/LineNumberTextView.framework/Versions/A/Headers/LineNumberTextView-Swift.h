...
SWIFT_CLASS("_TtC18LineNumberTextView18LineNumberTextView")
@interface LineNumberTextView : NSTextView

/// Holds the text color for the gutter. Available in the Inteface Builder.
@property (nonatomic, strong) NSColor * _Nullable gutterForegroundColor;

/// Holds the background color for the gutter. Available in the Inteface Builder.
@property (nonatomic, strong) NSColor * _Nullable gutterBackgroundColor;
- (void)awakeFromNib;
